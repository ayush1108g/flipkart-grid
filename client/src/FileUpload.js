  ...
  const showresultToggleModal = async () => {
    ...
    try {
      ...
      const [response, response1] = await Promise.all([
        axios.post(
          "https://flipkart-grid-mmwt.onrender.com/predict",
          formData,
          {
            headers: {
        ...
        axios.post(
          "https://flipkart-grid-mmwt.onrender.com/predict1",
          formData,
          {
            headers: {
              "Content-Type": "multipart/form-data", // Set the correct content type
      ...
      <main className="flex-grow flex justify-center items-center py-12 px-4">
        <div className="bg-gray-800 p-6 md:p-8 rounded-lg shadow-lg w-full max-w-lg border border-gray-700">
          ...
          <div className="flex justify-center mb-0">
            <img src={logo} alt="KartScan Logo" className="w-32 h-auto" />{" "}
          ...
          >
            ...
            <p className="text-yellow-400">
              Drag and drop or <span className="underline">browse</span> (Only
              images allowed)
            </p>
          </div>
